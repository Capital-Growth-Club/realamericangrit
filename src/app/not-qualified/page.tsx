    ...
    <div className="relative min-h-[100dvh] bg-[#0B2341] text-white flex flex-col">
      ...
      <div className="relative flex-1 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative w-full max-w-xl mx-auto px-5 sm:px-8 py-16 sm:py-24 text-center">
          ...
          >
            These demos are reserved for <span className="text-[#BF0A30]">home service owners.</span>
          </h1>

          <div className="space-y-4 text-base sm:text-lg text-gray-400 leading-relaxed mb-10 max-w-md mx-auto">
            <p>
              Real American Grit was built specifically for home service operators doing <strong className="text-white">$1M+</strong> in annual revenue &mdash; with the goal of pushing them to $2M&ndash;$10M and beyond.
            </p>
            <p>
