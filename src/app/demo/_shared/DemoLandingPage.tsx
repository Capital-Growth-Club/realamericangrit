    ...
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <Section id="curriculum" className="scroll-mt-[140px] py-16 sm:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          ...
          {/* Big CTA button — replaces the prior CTA callout band so we don't
              stack two navy sections in a row (this section already ends on a
              navy platform card and the next section is the navy deep-dives
              intro). White-bg + a single bold button keeps the page flowing. */}
      ...
      <Section className="py-16 sm:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          ...
          <p className="text-center text-sm text-[#475569]">
            Want to see exactly what&rsquo;s inside before you commit? <span className="text-[#0B2341] font-semibold">Book a 15-minute walkthrough.</span>
          </p>
        </div>
      </Section>
