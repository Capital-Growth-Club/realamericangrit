...
function CtaButton({ variant = "red", className = "", onClick, label }: { variant?: "red" | "outline-white" | "outline-dark"; className?: string; onClick?: () => void; label?: string }) {
  ...
  const defaultLabel = variant === "red" ? "Get Instant Access — $997/mo" : "Enroll Now — $997/mo";
  return (
        ...
        <div className="bg-[#1a3a6b] text-white px-4 py-3">
          <div className="flex items-center justify-center gap-3">
            ...
            <p className="text-[11px] sm:text-base font-semibold">
              Limited Time Launch Promo: <span className="line-through opacity-60">$1,997/mo</span> <span className="font-bold">$997/mo</span> — ends May 31
            </p>
          </div>
        </div>
        {/* Nav */}
          ...
          <Stagger i={5} className="mb-10">
            <div className="bg-[#f8f8f6] rounded-2xl p-7 sm:p-8 border-2 border-[#b71c1c]/20">
              ...
              <div className="text-center space-y-2 mb-8">
                ...
                <p className={`text-2xl sm:text-3xl font-black text-[#475569] line-through opacity-60 ${hFont}`}>$1,997/mo</p>
                <p className={`text-base font-bold text-[#b71c1c] uppercase tracking-wider ${hFont}`}>Launch Price — until May 31</p>
                <p className={`text-5xl sm:text-6xl font-black text-[#0a1628] ${hFont}`}>$997<span className="text-2xl text-[#475569] font-medium">/mo</span></p>
              </div>
        ...
        <div className="max-w-xl mx-auto px-5 sm:px-8">
          ...
          <div className="relative bg-[#0a1628] text-white rounded-3xl p-8 sm:p-10 shadow-2xl shadow-[#0a1628]/25">
            ...
            <div className="relative">
              ...
              <p className="text-center text-gray-500 text-base mb-8">Full course access + coaching — billed monthly</p>
